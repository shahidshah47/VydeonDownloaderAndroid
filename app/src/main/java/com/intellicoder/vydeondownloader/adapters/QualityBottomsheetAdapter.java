        ...
        if (issingle) {
            ...
            holder.downloadbtnd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new downloadFile().Downloading(context, vidurl, vidSource + "_" + System.currentTimeMillis(), ".mp4");
                                    ...
                                    new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (files.getEXT().equals("com") || files.getEXT().equals("")) {
                                                new downloadFile().Downloading(context, files.getURL(), vidSource + "_" + System.currentTimeMillis(), ".mp4");
                                            } else if (files.getEXT().equals("gif")) {
                                                new downloadFile().DownloadingInsta(context, files.getURL(), vidSource + "_" + System.currentTimeMillis(), "." + files.getEXT());
                                            } else {
                                                new downloadFile().Downloading(context, files.getURL(), vidSource + "_" + System.currentTimeMillis(), "." + files.getEXT());
                                            }
                                        }
                                    });
                }
