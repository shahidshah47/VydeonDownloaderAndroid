...
import com.intellicoder.vydeondownloader.FullImageActivity;
import com.intellicoder.vydeondownloader.PlayActivity;
import com.intellicoder.vydeondownloader.R;
import com.intellicoder.vydeondownloader.models.storymodels.ModelInstaItem;
        ...
        viewHolder.relativinstastoryplace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (modelInstaItem.getMedia_type() == 2) {
                    ...
                    context.startActivity(new Intent(context, PlayActivity.class).putExtra("videourl", modelInstaItem.getVideo_versions().get(0).getUrl()).putExtra(AppMeasurementSdk.ConditionalUserProperty.NAME, "allvideo" + System.currentTimeMillis() + ".mp4"));
                } else {
                    try {
        ...
        viewHolder.downloadID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (modelInstaItem.getMedia_type() == 2) {
                    ...
                    downloadFile.DownloadingInsta(context, modelInstaItem.getVideo_versions().get(0).getUrl(),
                            "instastory_" + modelInstaItem.getId(), ".mp4");
                } else {

                    downloadFile.DownloadingInsta(context, modelInstaItem.getImage_versions2().getCandidates().get(0).getUrl(),
