...
import com.intellicoder.vydeondownloader.databinding.ActivityTikTokWebviewBinding;
        ...
        binding.downloadFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (latsresult != null && !latsresult.equals("") && latsresult.contains("http")) {
                    ...
                    new downloadFile().Downloading(TikTokWebview.this, latsresult, "TikTokWeb_" + System.currentTimeMillis(), ".mp4");
