 ...
 */
public class DronePresenter extends BasePresenter<SentryLocationMvpView> {
    ...
    @Inject
    public DronePresenter(@ApplicationContext Context context, DataManager dataManager) {
    ...
    @Override
    public void attachView(SentryLocationMvpView mvpView) {
    ...
    public void getLocationList() {
        ...
        mSubscription = mDataManager.getNetworkService().completeDroneList("bearer" + authToken)
    ...
    private void parseResponse(BaseModel resp) {
        ...
        getMvpView().showItems(resp.getData().getSites());
    }
}
