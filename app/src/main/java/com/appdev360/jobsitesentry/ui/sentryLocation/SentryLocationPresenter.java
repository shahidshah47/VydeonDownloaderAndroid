...
public class SentryLocationPresenter extends BasePresenter<SentryLocationMvpView> {
    ...
    @Inject
    public SentryLocationPresenter(@ApplicationContext Context context, DataManager dataManager) {
