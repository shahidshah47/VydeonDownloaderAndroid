 ...
 */
public class AlarmNotificationPresenter extends BasePresenter<AlarmNotificationMvpView>{
    ...
    @Inject
    public AlarmNotificationPresenter(@ApplicationContext Context context, DataManager dataManager) {
    ...
    @Override
    public void attachView(AlarmNotificationMvpView mvpView) {
    ...
    public void getAlarmNotifications(String pageNo) {
        checkViewAttached();
        ...
        mSubscription = mDataManager.getNetworkService().getAlarmNotification("bearer"+authToken,pageNo)
    ...
    private void parseResponse(BaseModel resp) {
        ...
        getMvpView().onNotificationReceived(data);
